...
test_that("tsum_test() may not be giving T statistics", {
  ...
  expect_output(tsum_test(exstra_wgs_pcr_2[c("HD", "SCA6", "SCA1", "FRDA")]), "Defined p-values:  72")
  expect_output(tsum_test(exstra_wgs_pcr_2[c("HD", "SCA6")], give.pvalue = FALSE), "Pre-extracted tests: 36")
})
