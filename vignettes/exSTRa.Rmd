...
---
#Commented out these lines until parallel is worth using again
You may use the parallel package to speed this up (parallel = TRUE); by default this uses 
1 less thread than available on your system. 
---
